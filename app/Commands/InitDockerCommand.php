...
final class InitDockerCommand extends Command
{
    ...
    public function handle(InstallationAdvisor $advisor): int
    {
        ...
        $this->newLine();
        $this->info('🐳 PHP Debug Pilot — Docker Configuration');
        ...
        $this->newLine();
        $this->info('💡 Tip: Debug Pilot auto-detects Docker and resolves');
    ...
    {
        $this->info('📄 Add this to your Dockerfile:');
        $this->newLine();

        $installCommand = $advisor->getDockerfileCommand($debugger);

        $lines = [
            "# === PHP Debug Pilot — {$this->humanName($debugger)} Configuration ===",
            $installCommand,
        ];
